...
create_project -name MUX_4X1 -dir "E:/VHDL/MUX_4X1/planAhead_run_2" -part xc7a100tcsg324-1
set_param project.pinAheadLayout yes
set srcset [get_property srcset [current_run -impl]]
set_property target_constrs_file "MUX_4X1.ucf" [current_fileset -constrset]
set hdlfile [add_files [list {MUX_4X1.vhd}]]
set_property file_type VHDL $hdlfile
set_property library work $hdlfile
set_property top MUX_4X1 $srcset
