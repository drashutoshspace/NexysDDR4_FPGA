...
HD_PWD='D:/Projects/FPGA/adder_sub/adder_sub.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_FA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_FA.tcl -notrace
