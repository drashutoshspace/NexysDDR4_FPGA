...
HD_PWD='D:/Projects/FPGA/adder_sub/adder_sub.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_FA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_FA.tcl
